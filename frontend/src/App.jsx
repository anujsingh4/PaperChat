...
export default function App() {
  ...
  const handleNewChat = () => {
    setMessages([]),
    setActiveDocIds([]) // clear active docs on new conversation
  }
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-72 bg-white border-r border-gray-200 flex flex-col p-4">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-gray-400">{documents.length} indexed</span>
        </div>
        <DocumentList documents={documents} activeDocIds={activeDocIds} onDelete={loadDocuments} />
        <button
